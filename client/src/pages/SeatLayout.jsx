  ...
  return show ? (
    <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50">
        ...
        <div className="mt-5 space-y-1">
          {show.dateTime[date].map((item) => (
            <div
              ...
              className={`flex items-center gap-2 px-6 py-2w-max rounded-r-md cursor-pointer transition ${selectedTime?.time === item.time ? "bg-primary text-white" : "hover:bg-primary/20"}`}
            >
      ...
      <div className="relative flex-1 flex flex-col items-center max-md:mt-16">
        <BlurSection top="-100px" left="-100px" />
        <BlurSection bottom="0px" right="0px" />
